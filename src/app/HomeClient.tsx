...
interface HomeClientProps {
  initialConfig: ScrapingConfig;
  initialActiveOperation?: { type: OperationType; source?: string } | null;
}

export function HomeClient({ initialConfig, initialActiveOperation }: HomeClientProps) {
  const router = useRouter();
  const [config] = useState<ScrapingConfig>(initialConfig);
